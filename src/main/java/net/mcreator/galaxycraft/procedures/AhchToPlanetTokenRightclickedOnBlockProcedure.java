...
public class AhchToPlanetTokenRightclickedOnBlockProcedure {
	public static void execute(Entity entity) {
		...
		if (entity instanceof ServerPlayer _player && !_player.level().isClientSide()) {
			ResourceKey<Level> destinationType = ResourceKey.create(Registries.DIMENSION, ResourceLocation.parse("galaxycraft:ahch_to"));
