...
public class MuddySwampTrunkDecorator extends TrunkVineDecorator {
	public static MapCodec<MuddySwampTrunkDecorator> CODEC = MapCodec.unit(MuddySwampTrunkDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("galaxycraft:muddy_swamp_tree_trunk_decorator"), () -> DECORATOR_TYPE);
	}
