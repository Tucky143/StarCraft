...
public class DeadForestLeaveDecorator extends LeaveVineDecorator {
	public static MapCodec<DeadForestLeaveDecorator> CODEC = MapCodec.unit(DeadForestLeaveDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("galaxycraft:dead_forest_tree_leave_decorator"), () -> DECORATOR_TYPE);
	}
