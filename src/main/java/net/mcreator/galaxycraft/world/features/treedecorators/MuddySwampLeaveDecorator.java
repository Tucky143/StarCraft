...
public class MuddySwampLeaveDecorator extends LeaveVineDecorator {
	public static MapCodec<MuddySwampLeaveDecorator> CODEC = MapCodec.unit(MuddySwampLeaveDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("galaxycraft:muddy_swamp_tree_leave_decorator"), () -> DECORATOR_TYPE);
	}

	public MuddySwampLeaveDecorator() {
		super(0.25f);
	}
