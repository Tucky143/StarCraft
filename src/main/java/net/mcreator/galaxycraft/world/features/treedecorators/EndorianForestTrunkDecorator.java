...
public class EndorianForestTrunkDecorator extends TrunkVineDecorator {
	public static MapCodec<EndorianForestTrunkDecorator> CODEC = MapCodec.unit(EndorianForestTrunkDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("galaxycraft:endorian_forest_tree_trunk_decorator"), () -> DECORATOR_TYPE);
	}
