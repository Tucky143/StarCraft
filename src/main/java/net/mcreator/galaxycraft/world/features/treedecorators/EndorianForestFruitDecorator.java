...
public class EndorianForestFruitDecorator extends CocoaDecorator {
	public static MapCodec<EndorianForestFruitDecorator> CODEC = MapCodec.unit(EndorianForestFruitDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("galaxycraft:endorian_forest_tree_fruit_decorator"), () -> DECORATOR_TYPE);
	}

	public EndorianForestFruitDecorator() {
		super(0.2f);
	}
