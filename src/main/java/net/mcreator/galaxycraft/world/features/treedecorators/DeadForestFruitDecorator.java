...
public class DeadForestFruitDecorator extends CocoaDecorator {
	public static MapCodec<DeadForestFruitDecorator> CODEC = MapCodec.unit(DeadForestFruitDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("galaxycraft:dead_forest_tree_fruit_decorator"), () -> DECORATOR_TYPE);
	}
