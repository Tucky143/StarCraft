...
public class WhiteLightsaberItem extends SwordItem {
	private static final Tier TOOL_TIER = new Tier() {
		...
		public Ingredient getRepairIngredient() {
			return Ingredient.of(new ItemStack(GalaxycraftModItems.WHITE_KYBER.get()));
		}
	};

	public WhiteLightsaberItem() {
		super(TOOL_TIER, new Item.Properties().attributes(SwordItem.createAttributes(TOOL_TIER, 8f, -2.7f)));
	}
