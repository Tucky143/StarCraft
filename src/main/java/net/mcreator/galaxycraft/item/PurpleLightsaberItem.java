...
public class PurpleLightsaberItem extends SwordItem {
	private static final Tier TOOL_TIER = new Tier() {
		...
		public Ingredient getRepairIngredient() {
			return Ingredient.of(new ItemStack(GalaxycraftModItems.PURPLE_KYBER.get()));
		}
	};

	public PurpleLightsaberItem() {
		super(TOOL_TIER, new Item.Properties().attributes(SwordItem.createAttributes(TOOL_TIER, 11f, -2.7f)));
	}
