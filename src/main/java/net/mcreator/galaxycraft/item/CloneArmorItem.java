...
public abstract class CloneArmorItem extends ArmorItem {
	...
	public static void registerArmorMaterial(RegisterEvent event) {
		event.register(Registries.ARMOR_MATERIAL, registerHelper -> {
			...
			}), 18, BuiltInRegistries.SOUND_EVENT.wrapAsHolder(SoundEvents.EMPTY), () -> Ingredient.of(new ItemStack(Items.QUARTZ)), List.of(new ArmorMaterial.Layer(ResourceLocation.parse("galaxycraft:clone"))), 1.2f, 0.1f);
			registerHelper.register(ResourceLocation.parse("galaxycraft:clone_armor"), armorMaterial);
