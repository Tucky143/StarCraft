...
public class HardenedMudBlock extends Block {
	...
	public HardenedMudBlock() {
		super(BlockBehaviour.Properties.of().instrument(NoteBlockInstrument.BASEDRUM).sound(SoundType.MUD).strength(6f, 10f).requiresCorrectToolForDrops().friction(0.5f));
