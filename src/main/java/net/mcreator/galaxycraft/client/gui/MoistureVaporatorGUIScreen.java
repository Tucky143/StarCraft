package net.mcreator.galaxycraft.client.gui;
...
public class MoistureVaporatorGUIScreen extends AbstractContainerScreen<MoistureVaporatorGUIMenu> {
	...
	private static final ResourceLocation texture = ResourceLocation.parse("galaxycraft:textures/screens/moisture_vaporator_gui.png");
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.galaxycraft.moisture_vaporator_gui.label_moisture_vaporator"), 43, 3, -12829636, false);
	}
