...
import net.mcreator.galaxycraft.fluid.LiquidMudFluid;
import net.mcreator.galaxycraft.GalaxycraftMod;

public class GalaxycraftModFluids {
	public static final DeferredRegister<Fluid> REGISTRY = DeferredRegister.create(BuiltInRegistries.FLUID, GalaxycraftMod.MODID);
