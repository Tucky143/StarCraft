...
public class EndorianForestTrunkDecorator extends TrunkVineDecorator {
	public static Codec<EndorianForestTrunkDecorator> CODEC = Codec.unit(EndorianForestTrunkDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(ForgeRegistries.Keys.TREE_DECORATOR_TYPES, registerHelper -> registerHelper.register("endorian_forest_tree_trunk_decorator", DECORATOR_TYPE));
	}
