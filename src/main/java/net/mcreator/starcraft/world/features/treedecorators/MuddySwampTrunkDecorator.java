...
@Mod.EventBusSubscriber(bus = Mod.EventBusSubscriber.Bus.MOD) public class MuddySwampTrunkDecorator extends TrunkVineDecorator {

    public static Codec<MuddySwampTrunkDecorator> CODEC = Codec.unit(MuddySwampTrunkDecorator::new);

    public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent public static void registerTreeDecorator(RegisterEvent event) {
		event.register(ForgeRegistries.Keys.TREE_DECORATOR_TYPES, registerHelper -> registerHelper.register("muddy_swamp_tree_trunk_decorator", DECORATOR_TYPE));
	}
