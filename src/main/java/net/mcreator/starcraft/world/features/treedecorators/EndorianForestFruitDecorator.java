...
public class EndorianForestFruitDecorator extends CocoaDecorator {
	public static Codec<EndorianForestFruitDecorator> CODEC = Codec.unit(EndorianForestFruitDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(ForgeRegistries.Keys.TREE_DECORATOR_TYPES, registerHelper -> registerHelper.register("endorian_forest_tree_fruit_decorator", DECORATOR_TYPE));
	}
