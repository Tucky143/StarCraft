...
public record ForcePushMessage(int eventType, int pressedms) implements CustomPacketPayload {
	public static final Type<ForcePushMessage> TYPE = new Type<>(ResourceLocation.fromNamespaceAndPath(StarcraftMod.MODID, "key_force_push"));
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		StarcraftMod.addNetworkMessage(ForcePushMessage.TYPE, ForcePushMessage.STREAM_CODEC, ForcePushMessage::handleData);
	}
}
